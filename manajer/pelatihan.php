...
$query = "SELECT COUNT(*) AS jumlah_pelatihan FROM tb_pelatihan WHERE status IN ('Proses', 'Dibayar', 'Selesai')";
...
$jumlah_laba_bersih = $jumlah_pendapatan - $total_gaji - $total_bensin;
        ...
        <div class="main">
            ...
            <div class="cardBox">
                ...
                <div class="card">
                    <div>
                        <div style="color: red;" class="numbers">
                            <?php echo "- Rp " . number_format($total_gaji, 0, ',', '.'); ?>
                        </div>
                        <div class="cardName">Total Gaji</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <div style="color: red;" class="numbers">
                            <?php echo "- Rp " . number_format($total_bensin, 0, ',', '.'); ?>
                        </div>
                        <div class="cardName">Total Bensin</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Laba Bersih Pelatihan</div>
                    </div>
                        ...
                        <tbody>
                            <?php while ($data = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../instruktur/img/<?php echo $data['gambarbukti']; ?></td>"
                                            width="200px"><br>
                                        <?php echo "Rp " . number_format($data['nominal'], 0, ',', '.'); ?>
                                    </td>
                                    <td><?php echo "Rp " . number_format($data['harga'] - $data['nominal'] - 500000, 0, ',', '.'); ?>
                                    </td>
                                    <td>
                                        <span class="status 
                                        <?php
